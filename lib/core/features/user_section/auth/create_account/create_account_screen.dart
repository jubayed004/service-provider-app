...
import 'package:service_provider_app/core/features/user_section/auth/create_account/widgets/choose_catagory_alert_dialog_screen.dart';
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          Get.toNamed(AppRoutes.guestOnbrodingScreen);
                        },
                        child: CustomText(
