  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        padding: EdgeInsets.symmetric(horizontal: 20,vertical: 56),
        child: Column(
          ...
          children: [
            ...
            CustomText(text: AppStrings.mostPopularIn,fontWeight: FontWeight.w500,fontSize: 16.sp,),
            SizedBox(height: 24.h),
            Row(
              children: [
                CustomImage(imageSrc: AppIcons.cleaning),
                SizedBox(width: 12.w),
                CustomText(text: AppStrings.cleaning,fontSize: 20.sp,fontWeight: FontWeight.w500,),
              ],
            ),
